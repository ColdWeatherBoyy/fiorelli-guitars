...
const Card: FC<CardProps> = ({ title, body, children }) => {
	return (
		<div className="rounded-sm bg-gradient-to-br from-cyan-50/85 to-zinc-300/85 dark:from-cyan-950/90 dark:to-zinc-800/90 shadow-sm shadow-zinc-600/60 backdrop-blur-md px-6 py-4 md:px-8 md:py-6 transform transition">
			{title && (
				<div

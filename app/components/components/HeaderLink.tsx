		...
		<Link
			...
			className={`${playfair_display.className} text-2xl md:text-3xl ${
				isMobile
					...
					: "hover:underline hover:text-cyan-800 hover:transform hover:scale-[103%] active:text-cyan-900 active:transform active:scale-[97%] transition-transform duration-200"
			}`}
		>
			{text}
		</Link>

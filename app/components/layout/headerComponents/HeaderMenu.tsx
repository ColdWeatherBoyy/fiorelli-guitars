		...
		<>
			{screenSize === ScreenSize.extraSmall ? (
				<motion.div
					...
					className="z-20 absolute rounded-sm top-16 border border-cyan-700/30 dark:border-cyan-500/30 border-r-0 w-[40%] right-0 bg-gradient-to-b from-cyan-50 dark:from-cyan-900 to-zinc-200 dark:to-zinc-800 dark:bg-cyan-950 flex flex-col items-center gap-6 p-6 z-30 shadow-sm shadow-zinc-600/60"
